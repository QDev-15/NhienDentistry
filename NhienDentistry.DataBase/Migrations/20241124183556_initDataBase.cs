    ...
    public partial class initDataBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "HomeTitle", "This is home page of eShopSolution" },
                    { 2, "HomeKeyword", "This is keyword of eShopSolution" },
                    { 3, "HomeDescription", "This is description of eShopSolution" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "rang-su", new DateTime(2024, 11, 25, 1, 35, 54, 642, DateTimeKind.Local).AddTicks(9778), "Răng Sứ", null, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "rang-nhua", new DateTime(2024, 11, 25, 1, 35, 54, 644, DateTimeKind.Local).AddTicks(4651), "Răng Nhựa", null, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "en", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "English", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { "vi", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Tiếng Việt", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });

            migrationBuilder.InsertData(
                table: "News",
                columns: new[] { "Id", "Alias", "CategoryId", "CreatedDate", "Description", "FileSize", "LanguageId", "Name", "SortOrder", "UpdatedDate", "Url" },
                values: new object[] { 1, "", null, new DateTime(2024, 11, 25, 1, 35, 54, 644, DateTimeKind.Local).AddTicks(9582), "Bài viết test", 0L, null, "", 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "9cf9dbc0-b7e5-4fb9-84eb-5c04808bb368", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "tedu.international@gmail.com", true, "Quynh", "Nguyen", false, null, "tedu.international@gmail.com", "admin", "AQAAAAIAAYagAAAAEOOISuz1mnFobZt4NL9wB8P/H4aGC2V1ZjIQIdIMakJSNBH19/DXYsYyUlbBMpX+ZQ==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "vi", "Áo nam", "ao-nam", "Sản phẩm áo thời trang nam", "Sản phẩm áo thời trang nam", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "en", "Men Shirt", "men-shirt", "The shirt products for men", "The shirt products for men", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "vi", "Áo nữ", "ao-nu", "Sản phẩm áo thời trang nữ", "Sản phẩm áo thời trang women", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "en", "Women Shirt", "women-shirt", "The shirt products for women", "The shirt products for women", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
